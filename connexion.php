...
<section>
  <h1 class="display-4 text-center titre1 text-primary"> Connexion </h1>
  <div class="container">
    ...
    <div class="row">
      <div class="col-4 col-lg-5 "></div>
        <div class="col-4 col-lg-2 my-3">
            <input type="submit" value="Connexion" name="action" class="btn btn-block btn-primary rad lead">
        </div>
  </div>
...
<footer class=" foot text-center text-white" style="margin-top: 172px ;">
  <p class="mt-4">
