...
?>
    ...
    <div class="row">
      ...
      <div class="input-group col-lg-6  my-3">
        ...
        <input type="text" name="id"  class="form-control" placeholder="id (Just For This Alpha Version)" >
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="input-group col-lg-6  my-3">
        ...
        <input type="text" name="idv" class="form-control" placeholder="id Voiture (Just For This Alpha Version)" >
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="row">
        ...
        <div class="input-group col-lg-6  my-3">
          ...
          <input type="text" name="des"  class="form-control" placeholder="Destination" >
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="input-group col-lg-6  my-3">
          ...
          <input type="text" name="ptr"  class="form-control" placeholder="Point de rencontre" >
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="input-group col-lg-6 my-3">
        ...
        <input type="time" name="h" class="form-control" placeholder="Date" >
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-3"></div>
      <div class="col-lg-2">
        <input type="number" name="nbp" class="form-control" placeholder="N° places" >
      </div>
      <div class="col-lg-2">
        <input type="number" name="p" class="form-control" placeholder="Prix" >
      </div>
      <div class="col-lg-2 border w-75">
        <p class="text-secondary p-0 m-0">fumeurs ?</p>
        <div class="container m-0 p-0">
          <div class="row">
            <div class="col">
              <div class="form-check">
                <input class="form-check-input" type="radio" name="f" id="exampleRadios1" value="oui">
            ...
            <div class="col">
              <div class="form-check">
                <input class="form-check-input" type="radio" name="f" id="exampleRadios2" value="non">
    ...
    <div class="row">
      ...
      <div class="col-2 my-3"> <input type="submit" name="action" class="btn btn-block btn-primary rad lead" placeholder="Ajouter"></div>
  </div>
